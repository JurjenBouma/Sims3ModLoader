...
namespace Sims3ModLoader
{
    public class Sims3ModFile
    {
        ...
        public Process modExe = new Process();

        public Sims3ModFile(string filePath,string appStartupPath)
        {
            FilePath = filePath;
            AppStartUpPath = appStartupPath;
            Read();
            modExe.EnableRaisingEvents = true;
            modExe.Exited += new EventHandler(OnModExeExit);
        }
        private void Read()
        {
        ...
        public void LoadMod()
        {
            ...
            modExe.StartInfo.FileName = exePath;
            modExe.Start();
        }
        public void UnLoadMod()
        {
            ...
            try
            {
                modExe.EnableRaisingEvents = false;
                modExe.Kill();
            }
            catch { }
        }
        private void OnModExeExit(object obj, EventArgs e)
        {
            UnLoadMod();
        }
    }
